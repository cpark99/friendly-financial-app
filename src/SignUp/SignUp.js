      ...
      <section id="sign-up-section">
        ...
        <form>
          ...
          <div className="age-verification-field form-checkbox">
              <input type="checkbox" name="age-verification-checkbox" id="age-verification-checkbox" value="age" defaultChecked={true} required /><p className="checkbox-text">I am at least 18 years old</p>
          </div>
          <div className="email-checkbox form-checkbox">
            <input type="checkbox" name="request-email-checkbox" id="request-email-checkbox" value="email" defaultChecked={true} /><p className="checkbox-text">I agree to receive emails*</p>
          </div>
          <div className="call-checkbox form-checkbox">
            <input type="checkbox" name="request-call-checkbox" id="request-call-checkbox" value="call" defaultChecked={true} /><p className="checkbox-text">I agree to receive a call* from a professional</p>
          </div>
          <div className="newsletter-checkbox form-checkbox">
            <input type="checkbox" name="request-newsletter-checkbox" id="request-newsletter-checkbox" value="newsletter" defaultChecked={true} /><p className="checkbox-text">I agree to receive newsletters</p>
          </div>
