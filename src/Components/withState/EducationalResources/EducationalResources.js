    ...
    return (
      <section id="educational-resources-section" className="content">
        ...
        <div id="educational-resources-intro-text" className="text-container">
          <p>
            Financial strength is built on <span className="italic">integrity</span>.
          </p>
        ...
        <div id="educational-resources-container">
          <div className="flex-responsive-column-row">
            ...
            >
              ...
              >
                For 175 years, New York Life has been serving our clients. Learn more about what
                makes us one of the <span className="italic">highest rated</span> companies around.
              </p>
              <NavButton
            ...
            >
              ...
              <p id="life-plans-resources-description" className="resource-description-text">
                Creating a plan that changes, as your life evolves, is essential. Learn about which
                options are available to you at the different stages of your life, to ensure that
                you are <span className="italic">financially successful</span>.
              </p>
              <NavButton
          ...
          <div className="flex-responsive-column-row">
            <div
              ...
              className="educational-resource-container button-container text-container"
            >
              <h3 className="educational-resource-list-header" id="college-planning-list-header">
                College Planning:
              </h3>
              <p id="college-planning-resources-description" className="resource-description-text">
                Whether you have something started or nothing yet - create an analysis that will
                calculate what you need to set aside, to <span className="italic">guarantee</span>{' '}
                your loved one’s education.
              </p>
              <NavButton
            ...
            >
              ...
              <p id="life-insurance-resources-description" className="resource-description-text">
                As a top rated mutual company, our goal is to{' '}
                <span className="italic">be there</span> when it matters. Learn about the different
                benefits that come with each unique policy.
              </p>
              <NavButton
          ...
          <div className="flex-responsive-column-row">
            ...
            >
              ...
              <p id="retirement-resources-description" className="resource-description-text">
                Are you satisfied with your retirement? Learn about where you are, where you’d like
                to be, and the best options available to you and your loved ones, to enjoy the
