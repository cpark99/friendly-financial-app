    ...
    return (
      <section id="life-insurance-section" className="content flex-column-center">
        ...
        <div id="life-insurance-content" className="resource-container text-container">
          <p id="life-insurance-resources-text" className="resource-description-text">
            ...
            universal life. With a variety of products and riders to choose from, we can recommend a{' '}
            <span className="italic">customized solution</span> for almost any need you may have.
          </p>
