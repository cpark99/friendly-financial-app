      ...
      <section id="retirement-section" className="content flex-column-center">
        ...
        <div id="retirement-content">
          <div className="text-container">
            <p id="retirement-resources-text" className="resource-description-text">
              ...
              deferred annuities for the accumulation stage of retirement, as well as{' '}
              <span className="italic">guaranteed</span>
              <Tooltip message={'Guarantees backed by the claims-paying ability of the issuer.'}>
                <sup>4</sup>
              </Tooltip>{' '}
              future or immediate lifetime income annuities (fixed income annuities) that can help
              you turn savings into an income stream that will last a lifetime. With a registered
              representative, we can offer <span className="italic">mutual funds</span>
              <Tooltip
                message={
                  'Offered through NYLIFESecurities LLC (member FINRA/SIPC), a Licensed Insurance Agency.'
                }
